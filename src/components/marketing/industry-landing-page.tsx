  ...
  return (
    <div className="grid gap-4">
      <div
        ...
        className="h-[300px] overflow-hidden rounded-2xl border border-white/10 bg-zinc-900 bg-cover bg-center shadow-2xl shadow-black/30 sm:h-[360px] lg:h-[420px]"
        style={{
          backgroundImage: `url(${page.heroImage.src})`,
        }}
      />
      <article className="rounded-xl border border-white/10 bg-white p-4 text-zinc-950 shadow-lg">
        <p className="text-xs font-bold uppercase tracking-[0.12em] text-[var(--convo-orange)]">
          Convo widget
        </p>
