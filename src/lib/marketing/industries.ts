...
export const industryPages: IndustryPage[] = [
  ...
  },
  {
    ...
    compatibility: {
      ...
      description:
        "Show pet owners the right answer, then route them into the booking calendar or practice management workflow your team already uses.",
      note:
        "Example booking and veterinary practice management systems used by Australian clinics. Connection method depends on the clinic setup and should not imply a certified partnership unless confirmed.",
      tools: [
        {
          name: "Vetstoria",
          category: "Online booking",
          logoDomain: "vetstoria.com",
        },
        {
        ...
        },
        {
          ...
          logoDomain: "ezyvet.com",
        },
        {
          name: "Provet Cloud",
          category: "Practice management",
          logoDomain: "provet.com",
        },
        {
          name: "RxWorks",
          category: "Practice management",
          logoDomain: "software.covetrus.com",
        },
        {
          name: "AVImark",
          category: "Practice management",
          logoDomain: "avimark.net",
        },
        {
          name: "Covetrus Ascend",
          category: "Practice management",
          logoDomain: "covetrus.com",
        },
        {
          name: "OpenVPMS",
          category: "Practice management",
          logoDomain: "openvpms.com",
          logoUrl:
            "https://www.openvpms.com/public_c259_6797cfe3d520411896d3a2060755425c.png",
        },
      ],
    },
    supportHub: {
