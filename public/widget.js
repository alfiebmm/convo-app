"use strict";(()=>{function m(){let n=document.currentScript??document.querySelector("script[data-tenant]"),t=(i,s)=>n?.getAttribute(`data-${i}`)??s,e="";if(n&&n.src)try{e=new URL(n.src).origin}catch{}return{tenantId:t("tenant",""),color:t("color","#3B82F6"),welcome:t("welcome","Hi there! How can I help you today?"),name:t("name","Convo"),position:t("position","right"),apiBase:e}}function b(){let n="convo_visitor_id",t=localStorage.getItem(n);return t||(t="v_"+crypto.randomUUID(),localStorage.setItem(n,t)),t}function x(n){let t=n.position==="left"?"left: 20px;":"right: 20px;",e=n.position==="left"?"left: 20px;":"right: 20px;";return`
    *,
    *::before,
    *::after {
    ...
    @media (max-width: 640px) {
      .convo-panel {
        ...
        ${n.position==="left"?"left: 12px;":"right: 12px;"}
        border-radius: 12px;
